...
//       const medicines = invoiceData.medicines || []; // Extract medicines array
...
//           if (!medicineSnap.exists()) continue;
  
//           const medicineData = medicineSnap.data();
//           const updatedStripQuantity = (medicineData.quantity || 0) + (medicine.quantity || 0);
//           const updatedLooseQuantity = (medicineData.totalPieces || 0) + (medicine.lossQuantity || 0);
  
//           transaction.update(medicineRef, {
//             quantity: updatedStripQuantity,
//             totalPieces: updatedLooseQuantity,
//           });
//         }
...
// // Remove deleted invoice from the UI
...
//         // Handle rollover if loose quantity exceeds strip size
